...
[![Checks: 301 tests · ruff · mypy](https://img.shields.io/badge/checks-301%20tests%20%C2%B7%20ruff%20%C2%B7%20mypy-brightgreen.svg)](CONTRIBUTING.md)
...
pytest                    # 301 tests, no network, no live database
ruff check .
mypy                      # configured in pyproject.toml; passes clean
```

**301 tests, ~69% coverage, and mypy clean.** The suite never touches the network or a
...
| Dashboard, settings, audit, undo | ✅ built, 301 tests, mypy clean |
