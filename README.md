...
[![Checks: 363 tests · ruff · mypy](https://img.shields.io/badge/checks-363%20tests%20%C2%B7%20ruff%20%C2%B7%20mypy-brightgreen.svg)](CONTRIBUTING.md)
...
pytest                    # 363 tests, no network, no live database
ruff check .
mypy                      # configured in pyproject.toml; passes clean
```

**363 tests, ~69% coverage, and mypy clean.** The suite never touches the network or a
...
| Dashboard, settings, audit, undo | ✅ built, 363 tests, mypy clean |
