...
[![Checks: 308 tests · ruff · mypy](https://img.shields.io/badge/checks-308%20tests%20%C2%B7%20ruff%20%C2%B7%20mypy-brightgreen.svg)](CONTRIBUTING.md)
...
pytest                    # 308 tests, no network, no live database
ruff check .
mypy                      # configured in pyproject.toml; passes clean
```

**308 tests, ~69% coverage, and mypy clean.** The suite never touches the network or a
...
| Dashboard, settings, audit, undo | ✅ built, 308 tests, mypy clean |
