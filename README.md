...
pytest                    # 272 tests, no network, no live database
ruff check .
mypy                      # configured in pyproject.toml; passes clean
```

**272 tests, ~69% coverage, and mypy clean.** The suite never touches the network or a
...
| Dashboard, settings, audit, undo | ✅ built, 272 tests, mypy clean |
